# -*- coding: utf-8 -*-
"""FinalSimulation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_CJDuC1dFXLVOjiTLsujgx9y_pd8SuCZ
...
class AvenueModel(ap.Model):
    ...
    def closeFile(self):
        with open("/content/drive/Shareddrives/Graficas/Reto/EntregableFinal/testData.json", "w") as file:
...
parameters = {
    ...
    'cars': 16,             # Número de autos en la simulación
